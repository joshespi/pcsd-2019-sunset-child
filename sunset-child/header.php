			...
			<h1><?php echo get_bloginfo( 'name') ?></h1>
				...
				<aside>
					<ul class="sociallinks">
						<li><a href="http://www.instagram.com/SVDragons_Provo/"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-instagram-white.svg' ?>" alt="Link to Instagram" /></span>
							</a>
						</li>
